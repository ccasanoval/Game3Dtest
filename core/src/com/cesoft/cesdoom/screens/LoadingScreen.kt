...
class LoadingScreen(private val game: CesDoom) : Screen {
    ...
    private var loadingFrame: Image? = null
    private var loadingBarHidden: Image? = null
    private var screenBg: Image? = null
    private var loadingBg: Image? = null

    private var startX: Float = 0.toFloat()
    private var endX: Float = 0.toFloat()
    private var percent: Float = 0.toFloat()

    private var loadingBar: Actor? = null
