...
object HealthFactory {
    ...
    private val dimCollision = Vector3(HealthComponent.SIZE*2, HealthComponent.SIZE*2, HealthComponent.SIZE*2)

    //______________________________________________________________________________________________
    fun create(pos: Vector3, cuantity: Int, model: Model, engine: Engine): Health {

        /// Entity
        val entity = Health(cuantity)
        pos.y = PlayerComponent.ALTURA + HealthComponent.SIZE
