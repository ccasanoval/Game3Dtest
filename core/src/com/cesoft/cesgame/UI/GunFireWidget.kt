...
object GunFireWidget : Actor() {
	...
	//gfw.setPosition(CesGame.VIRTUAL_WIDTH / 2 +30, CesGame.VIRTUAL_HEIGHT / 2 -70)
	//gfw.setSize(100f, 100f)
	init {
		stage = Stage(FitViewport(CesGame.VIRTUAL_WIDTH, CesGame.VIRTUAL_HEIGHT))
		stage.addActor(this)
		setSize(100f, 100f)
		setPosition(+30f, -60f)
	}
	...
	override fun setPosition(x: Float, y: Float) {
		...
		fire.setPosition(CesGame.VIRTUAL_WIDTH/2f + x,  CesGame.VIRTUAL_HEIGHT/2f + y)
	}
...
/*private fun drawGunFire() {
	...
	spriteBatch.draw(
			gunFire,
			CesGame.VIRTUAL_WIDTH/2f, CesGame.VIRTUAL_WIDTH/2f,
